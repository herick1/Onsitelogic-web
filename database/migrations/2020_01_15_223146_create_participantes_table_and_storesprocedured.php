...
class CreateParticipantesTableAndStoresprocedured extends Migration
{
    ...
    public function up()
    {
        ...
        $sql = <<<SQL
            ...
            BEGIN
                INSERT INTO `Participante`(`cedula`,  `email`, `pimer_nombre`,`segundo_nombre`,`primer_apellido`,`segundo_apellido`,`fecha_de_nacimiento`,`telefono`,`tipo`,`fk_lugar` ) VALUES(_cedula, _email, _pimer_nombre, _segundo_nombre, _primer_apellido, _segundo_apellido, _fecha_de_nacimiento, _telefono, _tipo, _lugar );
            END;
